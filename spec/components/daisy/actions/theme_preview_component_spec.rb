...
RSpec.describe Daisy::Actions::ThemePreviewComponent, type: :component do
  ...
  describe "#before_render" do
    it "calls setup_component and setup_dots" do
      allow(component).to receive(:setup_component)
      allow(component).to receive(:setup_dots)
      
      component.before_render
      
      expect(component).to have_received(:setup_component)
      expect(component).to have_received(:setup_dots)
    end
  end
