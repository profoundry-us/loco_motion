...
module Daisy
  module Mockup
    ...
    class BrowserComponent < LocoMotion::BaseComponent
      ...
      #
      # This method exists so the doc comment above has a real method to
      # attach to; BrowserComponent has no options of its own beyond the
      # universal ones documented here.
      def initialize(**kws)
        super(**kws)
      end
