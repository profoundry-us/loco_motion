...
module LocoMotion
  ...
  COMPONENTS = {
    ...
    "Daisy::Actions::DropdownComponent" => { names: "dropdown", group: "Actions", title: "Dropdowns",
                                             example: "dropdowns" },
    ...
    "Daisy::DataDisplay::AccordionComponent" => { names: "accordion", group: "Data Display", title: "Accordions",
                                                  example: "accordions" },
    "Daisy::DataDisplay::AvatarComponent" => { names: "avatar", group: "Data Display", title: "Avatars",
                                               example: "avatars" },
    "Daisy::DataDisplay::BadgeComponent" => { names: "badge", group: "Data Display", title: "Badges",
                                              example: "badges" },
    "Daisy::DataDisplay::CardComponent" => { names: "card", group: "Data Display", title: "Cards", example: "cards" },
    "Daisy::DataDisplay::CarouselComponent" => { names: "carousel", group: "Data Display", title: "Carousels",
                                                 example: "carousels" },
    "Daisy::DataDisplay::ChatComponent" => { names: "chat", group: "Data Display", title: "Chat Bubbles",
                                             example: "chat_bubbles" },
    "Daisy::DataDisplay::CollapseComponent" => { names: "collapse", group: "Data Display", title: "Collapses",
                                                 example: "collapses" },
    "Daisy::DataDisplay::CountdownComponent" => { names: "countdown", group: "Data Display", title: "Countdowns",
                                                  example: "countdowns" },
    "Daisy::DataDisplay::DiffComponent" => { names: "diff", group: "Data Display", title: "Diffs", example: "diffs" },
    "Daisy::DataDisplay::FigureComponent" => { names: "figure", group: "Data Display", title: "Figures",
                                               example: "figures" },
    "Daisy::DataDisplay::KbdComponent" => { names: "kbd", group: "Data Display", title: "Keyboard (KBD)",
                                            example: "kbds" },
    ...
    "Daisy::DataDisplay::StatusComponent" => { names: "status", group: "Data Display", title: "Statuses",
                                               example: "statuses" },
    "Daisy::DataDisplay::TableComponent" => { names: "table", group: "Data Display", title: "Tables",
                                              example: "tables" },
    "Daisy::DataDisplay::TextRotateComponent" => { names: "text_rotate", group: "Data Display", title: "Text Rotates",
                                                   example: "text_rotates" },
    "Daisy::DataDisplay::TimelineComponent" => { names: "timeline", group: "Data Display", title: "Timelines",
                                                 example: "timelines" },

    # Data Input
    "Daisy::DataInput::CallyComponent" => { names: "cally", group: "Data Input", title: "Calendars",
                                            example: "calendars" },
    "Daisy::DataInput::CallyInputComponent" => { names: "cally_input", group: "Data Input", title: "Cally Inputs",
                                                 example: "cally_inputs" },
    "Daisy::DataInput::CheckboxComponent" => { names: "checkbox", group: "Data Input", title: "Checkboxes",
                                               example: "checkboxes" },
    "Daisy::DataInput::FileInputComponent" => { names: "file_input", group: "Data Input", title: "File Inputs",
                                                example: "file_inputs" },
    "Daisy::DataInput::FieldsetComponent" => { names: "fieldset", group: "Data Input", title: "Fieldsets",
                                               example: "fieldsets" },
    ...
    "Daisy::DataInput::RatingComponent" => { names: "rating", group: "Data Input", title: "Ratings",
                                             example: "ratings" },
    "Daisy::DataInput::SelectComponent" => { names: "select", group: "Data Input", title: "Selects",
                                             example: "selects" },
    "Daisy::DataInput::TextInputComponent" => { names: %w[input text_input], group: "Data Input",
                                                title: "Text Inputs", example: "text_inputs" },
    "Daisy::DataInput::TextAreaComponent" => { names: "text_area", group: "Data Input", title: "Text Areas",
                                               example: "text_areas" },
    "Daisy::DataInput::ToggleComponent" => { names: "toggle", group: "Data Input", title: "Toggles",
                                             example: "toggles" },

    # Navigation
    "Daisy::Navigation::BreadcrumbsComponent" => { names: "breadcrumbs", group: "Navigation", title: "Breadcrumbs",
                                                   example: "breadcrumbs" },
    ...
    "Daisy::Navigation::NavbarComponent" => { names: "navbar", group: "Navigation", title: "Navbars",
                                              example: "navbars" },
    "Daisy::Navigation::PaginationComponent" => { names: nil, group: "Navigation", title: "Pagination",
                                                  example: "pagination" },
    ...
    "Daisy::Feedback::RadialProgressComponent" => { names: "radial", group: "Feedback", title: "Radial Progress",
                                                    example: "radials" },
    "Daisy::Feedback::SkeletonComponent" => { names: "skeleton", group: "Feedback", title: "Skeletons",
                                              example: "skeletons" },
    "Daisy::Feedback::ToastComponent" => { names: "toast", group: "Feedback", title: "Toasts", example: "toasts" },
    "Daisy::Feedback::TooltipComponent" => { names: %w[tooltip tip], group: "Feedback", title: "Tooltips",
                                             example: "tooltips" },
    ...
    "Daisy::Layout::HoverGalleryComponent" => { names: "hover_gallery", group: "Layout", title: "Hover Galleries",
                                                example: "hover_galleries" },
    "Daisy::Layout::IndicatorComponent" => { names: "indicator", group: "Layout", title: "Indicators",
                                             example: "indicators" },
